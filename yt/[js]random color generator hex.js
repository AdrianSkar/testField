/// randColour from Steve Griffith's JS tutorial on optional chaining at https://youtu.be/G662_abEci0
...
/// my approach using hex values

const randCol = () => {
	let col = '';
	while (col.length < 8) { // 6 without alpha
